...
const faqs = [
  {
    question: 'Что такое защищённое соединение?',
    answer: 'Это технология, которая создаёт приватное интернет-подключение между вашим устройством и сетью. Она шифрует трафик и помогает сохранить конфиденциальность данных.'
  },
  {
    question: 'Как установить Moonlume?',
  ...
  {
    question: 'Можно ли использовать Moonlume на нескольких устройствах?',
    answer: 'Да. В зависимости от тарифа можно подключить 1, 3 или неограниченное количество устройств одновременно. Все подключения будут защищены.'
  },
  {
    question: 'Как работает бесплатный пробный период?',
    answer: 'Мы предоставляем 7 дней полностью бесплатного доступа ко всем функциям сервиса интернет-приватности. При регистрации не требуется вводить данные карты. После пробного периода можно выбрать подходящий тариф.'
  },
  {
